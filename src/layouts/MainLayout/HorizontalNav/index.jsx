  ...
  const menuItems = [
    {
      ...
      color: '#3b82f6',
      children: [
        { id: 'opic', label: t('sidebar.opicPractice'), icon: OpicIcon, path: '/opic', desc: t('sidebar.opicDesc') },
        { id: 'ai-talk', label: t('sidebar.aiTalk'), icon: AiIcon, path: '/freetalk/ai', desc: t('sidebar.aiTalkDesc') },
      ],
    },
    {
      id: 'writing',
      ...
      color: '#8b5cf6',
      children: [
        { id: 'chat-people', label: t('sidebar.chatPeople'), icon: PeopleIcon, path: '/freetalk/people', desc: t('sidebar.chatPeopleDesc') },
        { id: 'writing-practice', label: t('sidebar.writingPractice'), icon: WriteIcon, path: '/writing', desc: t('sidebar.writingPracticeDesc') },
      ],
    },
    {
      id: 'vocab',
      ...
      color: '#059669',
      children: [
        { id: 'vocab-daily', label: t('sidebar.vocabLearn'), icon: LearnIcon, path: '/vocab', desc: t('sidebar.vocabLearnDesc') },
        { id: 'vocab-test', label: t('sidebar.vocabTest'), icon: QuizIcon, path: '/vocab/test', desc: t('sidebar.vocabTestDesc') },
        { id: 'vocab-words', label: t('sidebar.vocabWords'), icon: WordListIcon, path: '/vocab/words', desc: t('sidebar.vocabWordsDesc') },
        { id: 'vocab-stats', label: t('vocabDash.viewStats'), icon: TrendingIcon, path: '/vocab/stats', desc: t('sidebar.reportsDesc') },
      ],
    },
    {
      id: 'dashboard',
