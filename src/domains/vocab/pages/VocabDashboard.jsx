      ...
      >
        ...
        <CardContent sx={{ p: { xs: 3, md: 4 }, position: 'relative', zIndex: 1 }}>
          ...
          <Box display="flex" gap={4} mb={4} flexWrap="wrap">
            <Box>
              <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.7)', textTransform: 'uppercase', letterSpacing: 0.5 }}>
                {isKorean ? '새 단어' : 'New Words'}
              </Typography>
              <Typography variant="h5" sx={{ color: 'white', fontWeight: 700 }}>
                {newWordsCount} <Typography component="span" variant="body2" sx={{ color: 'rgba(255,255,255,0.6)' }}>/ {DAILY_GOAL.NEW_WORDS}</Typography>
              </Typography>
            </Box>
            <Box>
              <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.7)', textTransform: 'uppercase', letterSpacing: 0.5 }}>
              ...
              <Typography variant="h5" sx={{ color: 'white', fontWeight: 700 }}>
                {reviewWordsCount} <Typography component="span" variant="body2" sx={{ color: 'rgba(255,255,255,0.6)' }}>/ {DAILY_GOAL.REVIEW_WORDS}</Typography>
              </Typography>
            </Box>
          </Box>
