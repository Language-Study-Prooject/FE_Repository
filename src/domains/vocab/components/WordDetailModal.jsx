            ...
            >
              <Box display="flex" justifyContent="space-around" mb={2}>
                <Box textAlign="center">
                  ...
                  <Typography variant="caption" color="text.secondary">{t('wordDetail.correctCount')}</Typography>
                </Box>
                <Box textAlign="center">
                  <Box
                    sx={{
                  ...
                  <Typography variant="caption" color="text.secondary">{t('wordDetail.incorrectCount')}</Typography>
                </Box>
                <Box textAlign="center">
                  <Box
                    sx={{
                  ...
                  <Typography variant="caption" color="text.secondary">{t('wordDetail.accuracyLabel')}</Typography>
                </Box>
              </Box>

              {userData.lastReviewedAt && (
                <Box display="flex" justifyContent="space-between" alignItems="center" pt={2} borderTop="1px solid #e7e5e4">
                  <Typography variant="body2" color="text.secondary">{t('wordDetail.lastReviewed')}</Typography>
              ...
              {userData.nextReviewAt && (
                <Box display="flex" justifyContent="space-between" alignItems="center" mt={1}>
                  <Typography variant="body2" color="text.secondary">{t('wordDetail.nextReview')}</Typography>
